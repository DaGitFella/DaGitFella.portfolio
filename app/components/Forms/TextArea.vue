<template>
  <div class="flex flex-col gap-2.5">
    <label for="mensagem" class="text-[16px] text-slate-400 font-medium"># Mensagem</label>
    ...
    dark:outline-emerald-400 dark:bg-slate-900 focus:outline-indigo-500 focus:outline-2
     px-7.5 py-4 dark:focus:outline-emerald-500 
     transition-colors 500 ease-in-out text-xl min-h-70" />
  </div>
</template>
