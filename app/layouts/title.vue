  ...
  <main class="flex flex-col items-center w-full pt-15 gap-8 lg:gap-12.5 h-fit">
    <div class="flex flex-col items-center gap-5">
      <h1
        ...
        rounded-lg py-1.5 px-7.5 w-fit lg:text-6xl text-2xl"
      >
        <span>></span>
        {{ props.title }}
        <span class="ml-2 w-2 h-3/4 bg-current animate-cursor-blink"></span>
      </h1>
      <p class="lg:w-152 w-90 lg:text-2xl text-sm text-center text-slate-400">{{ props.description }}</p>
    </div>
    <slot />
  </main>
</template>
